...
// @deno-types="https://esm.sh/@bridge-editor/dash-compiler@0.14.0-alpha.5"
export {
  Dash,
  FileSystem,
  initRuntimes,
} from "https://unpkg.com/@bridge-editor/dash-compiler@0.14.0-alpha.5/dist/dash-compiler.bundled.es.js";
...
import { default as dashPackageJson } from "https://unpkg.com/@bridge-editor/dash-compiler@0.14.0-alpha.5/package.json" with { type: "json" };
